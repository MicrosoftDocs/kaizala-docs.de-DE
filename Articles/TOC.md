...
# Erste Schritte
## [Übersicht über Kaizala-App](PartnerDocs/Kaizala_overview.md)
## [Übersicht über Kaizala-Verwaltungsportal](PartnerDocs/KaizalaManagementPortal.md)
## [Kaizala Gruppen](PartnerDocs/GroupsinKaizala.md)
## [Kaizala Aktionen](PartnerDocs/KaizalaActionCards.md)
## [Kaizala Verfügbarkeit und Downloadlinks](PartnerDocs/KaizalaDownloadlinks.md)

# Entwicklerplattform für
## [Informationen zu Microsoft Kaizala Developer-Plattform](developer-platform.md)
### [Connectors](connectors/README.md)
### [Kaizala Aktionen](Actions/README.md)

## Schnellstarts
### Verwenden Sie Connectors für die Integration von Kaizala
#### [Einrichten von Connectors](connectors/setup.md)
#### [Generieren Sie Zugriffstoken](connectors/Tokens.md)
#### [Rest-APIs](connectors/API.md)
#### [Webhooks](connectors/webHooks.md)

### Entwickeln einer Aktion Kaizala
#### [Aufbau des Kaizala Aktion-Pakets](Actions/anatomy.md)
...
### [Updates zu Kaizala Auto-Post Twitter (engl.)](BusinessSolutions/CorporateCommunications/AutoPostTwitterUpdatesToKaizala/AutoPostTwitterUpdatesToKaizala.md)
...
## [Schulungen für Endbenutzer](PartnerDocs/EndUserTrainings.md)
## [Schulungen für IT Admin & für Entwickler](PartnerDocs/PartnerTrainings.md)
## [FAQ für Entwickler](FAQ.md)
## [Grundlegend geändert](BreakingChanges.md)
## [Entwickler der Änderungsliste](DevChangelist.md)
