...
3. Laden Sie die [SharepointAnnouncementOnKaizala SolutionPackage.zip](/Articles/BusinessSolutions/CorporateCommunications/SharepointAnnouncementsonKaizala/SharepointAnnouncementOnKaizala-SolutionPackage.zip) (*Dies ist ein Flow-Paket*)
...
5. Bearbeiten Sie den Ablauf (*wie unten*)
   ...
   2. In der zweite Block des Datenflusses
      ...
      Ordnen Sie "Wert" Feld mit der Spaltentitel der Ankündigungsliste, die Ankündigung body(description) von dynamischen Inhalten hat. In den unten Beispiel ist der Spaltentitel "Ankündigung Body"
